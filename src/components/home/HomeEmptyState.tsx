  ...
  return (
    <section className="relative grid min-h-[80dvh] place-items-center overflow-hidden bg-white">
      ...
      <Container size="xl" className="relative z-10 text-center">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-base leading-relaxed text-gray-600 text-pretty sm:text-lg">
          Conectando con nuestra base de datos. La biblioteca aparecerá aquí en cuanto se
          configuren las variables de Supabase.
        </p>
